...
public class AppGUI implements ItemListener {
    ...
    private final static String ENCRYPT = "Send Encrypted Message";
    private final static String DECRYPT = "Decrypt Received Message";
    private final static String KEYS = "Generate Public and Private Keys";
    private final static String SETKEYS = "Set Public and/or Private Keys";
    
    public void addComponentToPane(Container pane) {
        //Put the JComboBox in a JPanel to get a nicer look.
        JPanel mainPanel = new JPanel(); //use FlowLayout
        String comboBoxItems[] = { ENCRYPT, DECRYPT, KEYS, SETKEYS};
        ...
        JPanel card4 = new SetKeys().getPanel();
